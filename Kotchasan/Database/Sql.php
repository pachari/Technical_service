...
class Sql
{
     ...
     * @return \self
     */
    /*public static function IFCheckcon($column_name1, $column_name2,$column_name3,$column_name4, $alias = null)
    {
        return self::create('IF('.self::fieldName($column_name1).'= '.self::fieldName($column_name2).')'.($alias ? ' AS `'.$alias.'`' : ''));
    }*/
