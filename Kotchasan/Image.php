...
class Image
{
     ...
     * @return array|bool
     */
    public static function resize($source, $target, $name, $width, $watermark ='TKS CHEMICAL (THAILAND) CO., LTD')
    {
        $info = @getimagesize($source);
     ...
     * @return resource
     */
    public static function watermarkText($imgsrc, $text, $pos = '', $color = '778899', $font_size = 20, $opacity = 50) // 'CCCCCC'
    {
