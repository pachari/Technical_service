<?php
/**
 * @filesource modules/index/views/editcustomer.php
 *
 */
       ...
       // $login_admin = Login::isAdmin();
        if (Login::checkPermission(Login::isMember(), 'can_manage_customer')) {
                        ...
                        $form = Html::create('form', array(
                            ...
                            'class' => 'setup_frm',
                            'autocomplete' => 'off',
                            'action' => 'index.php/index/model/editcustomer/submit',
                        ...
                        $table2 = new DataTable(array(
                            /* ข้อมูลใส่ลงในตาราง */
                            'datas' => \index\Editcustomer\Model::toDataTable($index[0]['customer_id']),
                        ...
                        // Javascript
                        $form->script('initEditCustomer("register");');
                        // คืนค่า HTML
